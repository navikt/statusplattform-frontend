...
const ArbeidsgiverDashboard = () => {
    ...
    useEffect(() => {
        (async function () {
            ...
            const arbeidsGiverDashboard: Dashboard | undefined = (dashboards.find(dashboard => dashboard.name == "Arbeidsgiver" ? dashboard : undefined))
...
export default ArbeidsgiverDashboard