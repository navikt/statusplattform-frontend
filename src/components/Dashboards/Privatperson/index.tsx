...
const PrivatpersonDashboard = () => {
    ...
    useEffect(() => {
        (async function () {
            ...
            const arbeidsGiverDashboard: Dashboard | undefined = (dashboards.find(dashboard => dashboard.name == "Privatperson" ? dashboard : undefined))
...
export default PrivatpersonDashboard