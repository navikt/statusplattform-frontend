...
export const fetchDashboardList = async (req: NextApiRequest, res: NextApiResponse) => {

    console.log("IN TEST API")

    let headers = req.headers
    let method = "GET"
    let path = backendPath + "/Dashboards"
    ...
    //Bytt ut myheaders med req.headers dersom en skal koble på auth
    let backEndRequest = createRequest(path, method, myHeaders)
